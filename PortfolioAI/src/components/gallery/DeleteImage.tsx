...
import { deleteImages } from "@/app/actions/image-action";
    ...
    return(
        <AlertDialog>
            ...
            <AlertDialogFooter>
                ...
                <AlertDialogAction className="bd-destructive hover:bg-destructive/90" onClick={handleDelete}>Delete</AlertDialogAction>
            </AlertDialogFooter>
            </AlertDialogContent>
      </AlertDialog>
