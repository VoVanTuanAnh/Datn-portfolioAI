...
const ModelsList = ({models}: ModelsListProps) =>{
    ...
    const handleDeleteModel = async(id: number, model_id: string, model_version:string) =>{
        ...
        if(success){
            toast.success("Model delete successfully!", {id: toastId})
        }
    }
        ...
        return(
            <Card className="flex h-[450px] flex-col items-center justify-center text-center">
                <CardHeader>
                    ...
                    <CardDescription>
                        You have not traind any models yet. Start by creating a new model.
                    </CardDescription>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogAction onClick={() => handleDeleteModel(model.id, model.model_id || "", model.version || "")}
                                    className="bg-destructive hover:bg-destructuve/90"
                        ...
                        <CardContent className="flex-1 p-0 pt-3">
                            <div className="space-y-3">
                                <div className="grid grid-cols-2 gap-3">
                                   ...
                                   <div className="round-lg bg-muted px-3 py-2">
                                    <div className="flex items-center gap-2 text-sm text-muted-ground">
